...
//#define HZ (20*1000000)
#define Too_Small_Time (1*HZ)
#define CLOCK_TYPE "gettimeofday"
#include<sys/time.h>
struct timeval run_time;
#define Start_Timer() ({gettimeofday(&run_time,NULL);Begin_Time = run_time.tv_sec;})
#define Stop_Timer() ({gettimeofday(&run_time,NULL);End_Time = run_time.tv_sec;})
